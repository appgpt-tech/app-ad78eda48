...
import { AnimeList, AnimeCreate, AnimeEdit } from './resources/Anime';
import { UserList, UserCreate, UserEdit } from './resources/User';
import { RatingList, RatingCreate, RatingEdit } from './resources/Rating';
import { CommentList, CommentCreate, CommentEdit } from './resources/Comment';
import AnimeIcon from '@mui/icons-material/LocalMovies';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/ad78eda48">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          ...
          create={RatingCreate}
          edit={RatingEdit}
          recordRepresentation="finalRating"
          icon={RatingIcon}
        />
        <Resource
          name="Comment"
          ...
          edit={CommentEdit}
          recordRepresentation="commentText"
          icon={CommentIcon}
        />
